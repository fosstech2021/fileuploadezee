    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
           ...
           if(_context.AboutUs.Any())
            ...
            var cause = await _context.Causes.OrderByDescending(c => c.Id).Take(3).ToListAsync();
            ...
            var events = await _context.Pages.OrderByDescending(s => s.Id).Take(3).ToListAsync();
