...
namespace BasePackageModule1.Areas.Unibase.Controllers
{
    ...
    public class CausesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var post = await _context.Causes
        ...
        public async Task<IActionResult> Create(IFormFile formImage, Cause post)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var post = await _context.Causes.FindAsync(id);
            if (post == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, IFormFile image, Cause post)
        {
            if (id != post.Id)
            {
                return NotFound();
            }
            var thisPost = await _context.Causes.FirstAsync(p => p.Id == post.Id);
